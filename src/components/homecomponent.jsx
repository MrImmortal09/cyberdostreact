  ...
  <div className="container">
    <div className="box1">
      ...
      <div className="simplifiedsecure">
        ...
        the knowledge and tools to protect themselves from cybercrime. Stay Safe
        and Informed with us.
      </div>
      <div className="start">
    ...
    <div className="box2">
      ...
      <div className="background2">
        <img
          src="undraw_pair_programming_re_or4x.svg"
          alt="stories"
          height="330vh"
        />
      </div>
      ...
      <br />
      <br />
      <input type="submit" className="signup" defaultValue="Sign up now" />
      <div className="EF">
      ...
      <input type="submit" className="explorenow" defaultValue="Explore Now" />
      ...
      <div className="caseText">Real life Stories related to Cybercrime</div>
        ...
        <div className="cardScroll">
          <div className="card">
            ...
            <div className="lower">
              ...
              <p>
                Our Services Led to a 40% Decrease in Cyber Attacks within 6
                Months
              </p>
              <h5>LOGO</h5>
            </div>
    ...
    <div className="box3">
      ...
      <div className="connectText">
        Reach out to our team for any questions or support. We are here to help
        you stay safe online and protect your digital life.
      </div>
      <input type="submit" className="contact" defaultValue="Send Message" />
      <div className="background4">
        <img
          src="undraw_contact_us_re_4qqt (1).svg"
          alt="contact us"
          className="contactus"
          height="290vh"
        />
    ...
    <div className="box4">
      ...
      <div className="aboutText">
        ...
        control of their online security. Our commimtment to privacy and data
        protection ensures a safe and secure online experience for all users.
      </div>
      <input type="submit" className="aboutus" defaultValue="Learn More" />
      <div className="background5">
        <img
          src="undraw_mobile_encryption_re_yw3o.svg"
          alt="trust"
          className="whytrust"
          height="300vh"
          width="450vw"
    ...
    <div className="box5">
      <footer>
        <div className="logofoot">
          <img
            src="Screenshot_2023-12-05_at_3.50.16_AM-removebg-preview.png"
            alt=""
            id="logoo"
          />
        </div>
        <div className="listt">
          ...
          <div className="list2">
            <ul className="ul2">
              ...
              <li className="li2">Help</li>
            </ul>
          </div>
          <div className="list3">
            <ul className="ul2">
              <li className="li2">Terms and Condition</li>
        ...
        <div className="lin">
          <p className="copyright">Copyright © CyberDost 2023</p>
        </div>
      </footer>
    </div>
  </div>
