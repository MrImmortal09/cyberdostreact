const ContactUs = () => {
    return (
      <>
        <section className="relative z-10 overflow-hidden bg-zinc-900 py-20 lg:py-[120px] text-[#00DF9A] px-8">
                  ...
                  <div className="mb-8 flex w-full max-w-[370px]">
                    ...
                    <div className="w-full">
                      ...
                      <p className="text-body-color text-base text-white">
                        IIIT Lucknow, Chak Ganjaria, C.G. City, Lucknow, Uttar Pradesh 226002
                      </p>
                    </div>
                  </div>
                  <div className="mb-8 flex w-full max-w-[370px]">
